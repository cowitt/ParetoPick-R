...
foo1(c("configr", "corrplot", "DT", "fs", "fst", 
       ...
       "spdep",    "tidyverse",  "tmap",  "viridis", "webshot2"))
...
pareto_path <- file.path(save_dir, "pareto_fitness.txt") # used frequently
# Ensure default directories exist (harmless if already present)
